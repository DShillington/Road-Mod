...
public class BlockGuardRail extends Block
{
    public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
    public static final PropertyEnum<BlockGuardRail.EnumHalf> HALF = PropertyEnum.<BlockGuardRail.EnumHalf>create("half", BlockGuardRail.EnumHalf.class);
    public static final PropertyEnum<BlockGuardRail.EnumShape> SHAPE = PropertyEnum.<BlockGuardRail.EnumShape>create("shape", BlockGuardRail.EnumShape.class);
    ...
    {
        return blockIn instanceof BlockGuardRail;
    }
    ...
    public int func_176307_f(IBlockAccess blockAccess, BlockPos pos)
    {
        ...
        BlockGuardRail.EnumHalf blockstairs$enumhalf = (BlockGuardRail.EnumHalf)iblockstate.getValue(HALF);
        boolean flag = blockstairs$enumhalf == BlockGuardRail.EnumHalf.TOP;
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        iblockstate = iblockstate.withProperty(FACING, placer.getHorizontalFacing()).withProperty(SHAPE, BlockGuardRail.EnumShape.STRAIGHT);
        return facing != EnumFacing.DOWN && (facing == EnumFacing.UP || (double)hitY <= 0.5D) ? iblockstate.withProperty(HALF, BlockGuardRail.EnumHalf.BOTTOM) : iblockstate.withProperty(HALF, BlockGuardRail.EnumHalf.TOP);
    }
    ...
    {
        IBlockState iblockstate = this.getDefaultState().withProperty(HALF, (meta & 4) > 0 ? BlockGuardRail.EnumHalf.TOP : BlockGuardRail.EnumHalf.BOTTOM);
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        if (state.getValue(HALF) == BlockGuardRail.EnumHalf.TOP)
        {
            i |= 4;
        }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        if (this.func_176306_h(worldIn, pos))
        {
            ...
            {
                case 0:
                    state = state.withProperty(SHAPE, BlockGuardRail.EnumShape.STRAIGHT);
                    break;
                case 1:
                    state = state.withProperty(SHAPE, BlockGuardRail.EnumShape.INNER_RIGHT);
                    break;
                case 2:
                    state = state.withProperty(SHAPE, BlockGuardRail.EnumShape.INNER_LEFT);
            }
        }
        else
        {
            switch (this.func_176307_f(worldIn, pos))
            {
                case 0:
                    ...
                    break;
                case 1:
                    state = state.withProperty(SHAPE, BlockGuardRail.EnumShape.OUTER_RIGHT);
                    break;
                case 2:
                    state = state.withProperty(SHAPE, BlockGuardRail.EnumShape.OUTER_LEFT);
            }
        }
