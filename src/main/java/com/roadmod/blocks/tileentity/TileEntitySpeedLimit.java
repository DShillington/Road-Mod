...
public class TileEntitySpeedLimit extends TileEntitySign
{
...
@Override
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            {
                return TileEntitySpeedLimit.this.pos;
            }
            /**
            ...
            {
                return new Vec3((double)TileEntitySpeedLimit.this.pos.getX() + 0.5D, (double)TileEntitySpeedLimit.this.pos.getY() + 0.5D, (double)TileEntitySpeedLimit.this.pos.getZ() + 0.5D);
            }
            /**
            ...
            {
                return TileEntitySpeedLimit.this.worldObj;
            }
            /**
...
@Override
    ...
    public boolean executeCommand(final EntityPlayer playerIn)
    {
        ICommandSender icommandsender = new ICommandSender()
        {
            ...
            public void setCommandStat(CommandResultStats.Type type, int amount)
            {
                TileEntitySpeedLimit.this.stats.func_179672_a(this, type, amount);
            }
        };
